 ...
 */
public class WxChat extends Tuple5<String, String, String, Long, String> {
    ...
    public WxChat(String wxId, String talker, String roomMsgWxId, long chatCreateTime, String type) {
        this.f0 = wxId;
        this.f1 = talker;
        this.f2 = roomMsgWxId;
